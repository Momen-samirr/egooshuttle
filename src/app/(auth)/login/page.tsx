...
export const metadata: Metadata = {
  title: "Sign In | EgooBus",
  description:
    "Sign in to your EgooBus account and manage your shared trip bookings.",
};
...
const features = [
  {
    icon: ShieldCheck,
    title: "Safe & Verified",
    description: "All trips are monitored with verified drivers.",
  },
  {
    icon: Bus,
    title: "Premium Fleet",
    description: "Travel in comfort on every route.",
  },
  {
    icon: Clock,
    title: "Always On Time",
    description: "Reliable schedules, every single day.",
  },
];
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: "rgba(134, 248, 152, 0.2)" }}
        />
        <div
        ...
        <div className="relative z-10 w-full max-w-md mr-0 ml-auto pr-0 pl-4">
          ...
          >
            Your precision journey continues. Sign in to access your bookings,
            track your trips, and ride with confidence.
          </p>
      ...
      >
        <div className="w-full max-w-md">
          ...
          {/* Form card — surface-container-lowest on surface-container-low = tonal elevation */}
          <div
      ...
      >
        ...
        <p className="text-xs opacity-70" style={{ color: "var(--color-on-surface-variant)" }}>
